...
public class GestureBuilderActivity extends ListActivity {
    ...
    private static File mStoreFile = new File(Environment.getExternalStorageDirectory(), "gestures");
    ...
    static GestureLibrary getStore() {
    	boolean deleted = mStoreFile.delete();
...
out:        for (String name : entries) {
    ...
    private Dialog createRenameDialog() {
        ...
        ((TextView) layout.findViewById(R.id.label)).setText("rename");
        ...
        builder.setNegativeButton("action",
